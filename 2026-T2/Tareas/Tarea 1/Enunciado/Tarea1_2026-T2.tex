...
\begin{ayuda}{Herramientas externas permitidas}
\vspace{2pt}
Pueden apoyarse en \textbf{herramientas externas} tanto para \textbf{obtener las
derivadas} (el gradiente $\nabla f$ y la matriz Hessiana $H_f$) como para
\textbf{encontrar los puntos críticos reales} de $f$: software simbólico
(p.\,ej.\ \texttt{SymPy}, WolframAlpha, GeoGebra, Symbolab) o calculadoras
numéricas / de derivadas en línea. Lo único exigido es \textbf{dejar constancia
en el informe} de qué herramienta utilizaron y cómo obtuvieron el resultado.
Lo que se evalúa es la implementación de los métodos y el análisis, no la
derivación a mano.
\end{ayuda}
...
\begin{enumerate}[leftmargin=*, topsep=2pt]
    ...
    \item \textbf{Objetivos:} un \textbf{objetivo general} y 
          \textbf{algunos objetivos específicos} que guíen el desarrollo.
...
\begin{itemize}[topsep=2pt]
    \item \textbf{Plazo de entrega:} \emph{Viernes 19 de Junio} (se anunciará en
          Canvas).
